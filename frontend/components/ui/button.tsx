...
const variantClasses: Record<Variant, string> = {
  ...
  outline: "border border-slate-700 text-slate-100 hover:bg-slate-800 focus-visible:outline-slate-600",
};
...
export const Button = forwardRef<HTMLButtonElement, Props>(function Button(
  ...
  return <button ref={ref} className={cx(baseClasses, variantClasses[variant], className)} {...props} />;
});
